...
def index():
    ...
    panel_links = {'products.list': 'Products', 'products.create': 'Add product',
                   ...
                   'admin_panel.list_shipment_methods': 'Shipment methods'}
...
def list_shipment_methods():
    ...
    shipment_methods_list = ShipmentMethodModel.query.all()
    data_dict = {'shipment_methods': shipment_methods_list}

    if len(shipment_methods_list) == 0:
